...
<div class="ve-table-outer-header">
    ...
    <div class="ve-input-search-wrap">
        <select class="ve-input-select" v-model="filterBy" @change="selectFilterBy">
            ...
            <option v-for="(column, index) in selectedColumns" :key="index" :value="column">{{column.label}}</option>
            <option value="all">All</option>
        </select>
        <div class="ve-input-search">
            <input :value="value" v-on:input="$emit('input', $event.target.value)" type="text" class="ve-input-search-box" :placeholder="config.search+' ...'">
                ...
                <card>
                    ...
                    <template #body>
                        <ul class="ve-custom-columns-list">
                            <li class="ve-custom-columns-list-item" v-for="(column, index) in columns" :key="index">
                                <label class="ve-checkbox">
                                    <input type="checkbox" :value="column" v-model="selectedColumns" @change="selectColumns">
    ...
    <div class="ve-table-outer-header-icons">
        ...
        <icon name="settings" class="ve-icon" @click.native="toggleCustomColumns=!toggleCustomColumns" />
    </div>
</div>
</template>
