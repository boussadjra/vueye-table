        ...
        <nav class="w-full min-h-screen bg-primary-50 dark:bg-primary-950">
            <ul class="w-full h-full">
                <li
                    ...
                    :class="{
                        'border-l-4 border-primary-600 bg-primary-100 dark:bg-primary-800':
                            link.children && index === currentOpen,
                    }"
                >
                    <div
                    ...
                    >
                        ...
                        <span
                            class="justify-self-end ml-auto i-tabler-chevron-right transition-transform"
                            :class="[index === currentOpen ? 'rotate-90' : 'rotate-0']"
                        />
                    </div>

                    <ul
                        v-if="link.children && index === currentOpen"
                        class="w-full h-full flex flex-col items-start justify-start ml-4"
                    >
                        <li
