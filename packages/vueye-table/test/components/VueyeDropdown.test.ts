...
//     it('renders the default option when no value is passed', () => {
//         const wrapper = render(VueyeDropdown, {
//             props: {
//                 options,
//             },
//         })

//         expect(wrapper.find('.dropdown__trigger span:first-child').text()).toBe('Option 1')
//     })
...
//         await wrapper.('.dropdown__trigger').trigger('click')
